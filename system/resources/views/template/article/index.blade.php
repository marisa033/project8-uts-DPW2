                        ...
                        <table class="table table-datatable">
                            ...
                            <tbody>
                                @foreach ($list_article as $article)
                                    ...
                                    <a href="{{url ('admin/article', $article->id)}}" class="btn btn-sm btn-dark"><i class="fa fa-info"></i></a>
                                    <a href="{{url ('admin/article', $article->id)}}/edit" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>
